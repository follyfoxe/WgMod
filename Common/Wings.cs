...
public class NewWings : GlobalItem
{
    public float GetWingWR(Item item)
    {
        switch(item.type)
        {
            ...
            case ItemID.BetsyWings or ItemID.FishronWings: return 0.35f;

            case ItemID.Hoverboard or ItemID.FestiveWings or ItemID.SpookyWings or ItemID.TatteredFairyWings or ItemID.SteampunkWings: return 0.32f;

            case ItemID.BoneWings or ItemID.MothronWings or ItemID.GhostWings or ItemID.BeetleWings: return 0.3f;

            case ItemID.Jetpack or ItemID.LeafWings or ItemID.BatWings or ItemID.BeeWings or ItemID.ButterflyWings or ItemID.FlameWings: return 0.27f;
            ...
            ItemID.GhostarsWings or ItemID.SafemanWings or ItemID.FoodBarbarianWings or ItemID.GroxTheGreatWings: return 0.25f;

            case ItemID.FairyWings or ItemID.FinWings or ItemID.FrozenWings or ItemID.HarpyWings: return 0.22f;
